...
public class MealController {
    ...
    @GetMapping("/history")
    @Operation(summary = "获取浏览历史", description = "查询用户的浏览历史记录(分页)")
    public Result<PageResult<MealVO>> getHistory(
        ...
        try {
            log.info("查询浏览历史: openId={}, page={}, size={}", openId, page, size);
            PageResult<MealVO> history = historyService.getUserHistory(openId, page, size);
