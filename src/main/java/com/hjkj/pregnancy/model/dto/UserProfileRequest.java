...
public record UserProfileRequest(
        ...
        @NotNull(message = "末次月经日期不能为空") @PastOrPresent(message = "末次月经日期不能是未来时间") @JsonFormat(pattern = "yyyy-MM-dd") @Schema(description = "末次月经日期", example = "2025-10-01") LocalDate lmp,
